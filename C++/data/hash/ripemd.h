...
namespace hash
{
	...
	class RIPEMD256 : public HASH<32, 64>
	{
		class tbf : public byteWriterBuf<block_size>
		{
			...
			{
				uint32_t a1 = st[0], b1 = st[1], c1 = st[2], d1 = st[3];
				uint32_t a2 = st[4], b2 = st[5], c2 = st[6], d2 = st[7];
	...
	public:
		...
		{
			buf.Fin();
			conv::unpack<4, endianness::LITTLE_ENDIAN>(buf.st, 8, r);
			buf.Init();
		}
	};
	...
	class RIPEMD320 : public HASH<40, 64>
	{
		class tbf : public byteWriterBuf<block_size>
		{
			...
			static void fn1(uint32_t &a, uint32_t b, uint32_t &c, uint32_t d, uint32_t e, uint32_t x, uint8_t s)
			{
				a += (b ^ c ^ d);
				f(a, c, e, x, s);
			}

			static void fn12(uint32_t &a, uint32_t b, uint32_t &c, uint32_t d, uint32_t e, uint32_t x, uint8_t s)
			{
				a += (d ^ (b & (c^d))) + 0x5a827999;
				f(a, c, e, x, s);
			}
			static void fn22(uint32_t &a, uint32_t b, uint32_t &c, uint32_t d, uint32_t e, uint32_t x, uint8_t s)
			{
				a += (d ^ (b & (c^d))) + 0x7a6d76e9;
				f(a, c, e, x, s);
			}

			static void fn13(uint32_t &a, uint32_t b, uint32_t &c, uint32_t d, uint32_t e, uint32_t x, uint8_t s)
			{
				a += ((b | ~c) ^ d) + 0x6ed9eba1;
				f(a, c, e, x, s);
			}
			static void fn23(uint32_t &a, uint32_t b, uint32_t &c, uint32_t d, uint32_t e, uint32_t x, uint8_t s)
			{
				a += ((b | ~c) ^ d) + 0x6d703ef3;
				f(a, c, e, x, s);
			}

			static void fn14(uint32_t &a, uint32_t b, uint32_t &c, uint32_t d, uint32_t e, uint32_t x, uint8_t s)
			{
				a += (c ^ (d & (b^c))) + 0x8f1bbcdc;
				f(a, c, e, x, s);
			}
			static void fn24(uint32_t &a, uint32_t b, uint32_t &c, uint32_t d, uint32_t e, uint32_t x, uint8_t s)
			{
				a += (c ^ (d & (b^c))) + 0x5c4dd124;
				f(a, c, e, x, s);
			}

			static void fn15(uint32_t &a, uint32_t b, uint32_t &c, uint32_t d, uint32_t e, uint32_t x, uint8_t s)
			{
				a += (b ^ (c | ~d)) + 0xa953fd4e;
				f(a, c, e, x, s);
			}
			static void fn25(uint32_t &a, uint32_t b, uint32_t &c, uint32_t d, uint32_t e, uint32_t x, uint8_t s)
			{
				a += (b ^ (c | ~d)) + 0x50a28be6;
				f(a, c, e, x, s);
			}
			...
			{
				uint32_t a1 = st[0], b1 = st[1], c1 = st[2], d1 = st[3], e1 = st[4];
				uint32_t a2 = st[5], b2 = st[6], c2 = st[7], d2 = st[8], e2 = st[9];
	...
	public:
		...
		{
			buf.Fin();
			conv::unpack<4, endianness::LITTLE_ENDIAN>(buf.st, 10, r);
			buf.Init();
		}
	};
}
