namespace hash
{
	class SHA384 : public HASH<48, 128>
	{
		class tbf : public byteWriterBuf<block_size>
		{
			...
			{
				conv::pack<8, endianness::BIG_ENDIAN>(v, block_size, x.data());
				Transform();
			}
		public:
			uint64_t st[8];
			...
			void Init()
			{
				st[0] = 0xcbbb9d5dc1059ed8;
				st[1] = 0x629a292a367cd507;
				st[2] = 0x9159015a3070dd17;
				st[3] = 0x152fecd8f70e5939;
				st[4] = 0x67332667ffc00b31;
				st[5] = 0x8eb44a8768581511;
				st[6] = 0xdb0c2e0d64f98fa7;
				st[7] = 0x47b5481dbefa4fa4;
				sz = 0;
			}
			void Fin()
			{
	...
	public:
		...
		{
			buf.Fin();
			conv::unpack<8, endianness::BIG_ENDIAN>(buf.st, 6, r);
			buf.Init();
		}
	};

	const uint64_t SHA384::tbf::K[80] = {
